  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('Profile', { username: username, user_id: user_id })}
      >
      ...
      <View style={styles.gridContainer}>
        ...
        >
          <Text style={styles.text_button}>Record Workout</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={[styles.text_button, styles.activeButtonText]}>Progress History</Text>
        </TouchableOpacity>
        <View style={styles.verticalLine} />
        <TouchableOpacity
          style={styles.gridButton}
